...
{
    mRenderShadow->use();
    mRenderShadow->SetMatrix4("lightSpaceMatrix", lightSpace);
}
...
Snow::Snow()
{
    ...
    mUpdateShader = new Shader("../../final/src/shaders/SnowUpdate.vs",
                               "../../final/src/shaders/SnowUpdate.fs",
                               "../../final/src/shaders/SnowUpdate.gs", varyings, 5);
    //设置TransformFeedback缓存能够记录的顶点的数据类型
    mRenderShader = new Shader("../../final/src/shaders/SnowRender.vs",
                               "../../final/src/shaders/SnowRender.fs");
    mRenderShadow = new Shader("../../final/src/shaders/SnowShadow.vs",
                               "../../final/src/shaders/SnowShadow.fs");
    //设置随机纹理
    InitRandomTexture(512);
	ResourceManager::LoadTexture("../../final/src/res/images/rain4.bmp", false, "mSparkTexture");
	
    mRenderShader->use();
    mRenderShader->SetInteger("snowflower", 0);
    mRenderShadow->use();
    mRenderShadow->SetInteger("snowflower", 0);
    glUseProgram(0);
    InitSnow();
}
